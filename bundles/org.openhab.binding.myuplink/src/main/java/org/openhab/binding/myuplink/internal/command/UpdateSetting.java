...
import static org.openhab.binding.myuplink.internal.MyUplinkBindingConstants.MANAGE_API_BASE_URL;
...
import org.openhab.binding.myuplink.internal.model.SwitchChannel;
 ...
 */
@NonNullByDefault
public class UpdateSetting extends AbstractUplinkCommandCallback implements MyUplinkCommand {
    ...
    public UpdateSetting(MyUplinkHandler handler, Channel channel, Command command) {
