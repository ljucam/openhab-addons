...
public final class F730Channels extends BaseChannels {
    ...
    public static final Channel CH_43181 = INSTANCE
            .addChannel(new QuantityChannel("43181", "Chargepump speed", ChannelGroup.COMPRESSOR, Units.PERCENT));
    public static final Channel CH_43424 = INSTANCE.addChannel(
            new QuantityChannel("43424", "EB100-EP14 Tot. HW op.time compr", ChannelGroup.COMPRESSOR, Units.HOUR));
    public static final Channel CH_43420 = INSTANCE.addChannel(
            new QuantityChannel("43420", "EB100-EP14 Tot. op.time compr", ChannelGroup.COMPRESSOR, Units.HOUR));
    ...
    public static final Channel CH_43136 = INSTANCE.addChannel(new QuantityChannel("43136",
            "Compressor Frequency, Actual", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, Units.HERTZ));
    public static final Channel CH_43122 = INSTANCE
            .addChannel(new QuantityChannel("43122", "Compr. current min.freq.", ChannelGroup.COMPRESSOR, Units.HERTZ));
    public static final Channel CH_43123 = INSTANCE
            .addChannel(new QuantityChannel("43123", "Compr. current max.freq.", ChannelGroup.COMPRESSOR, Units.HERTZ));
    public static final Channel CH_43066 = INSTANCE
            .addChannel(new QuantityChannel("43066", "Defrosting time", ChannelGroup.COMPRESSOR, Units.SECOND));

    // Airsupply
    public static final Channel CH_10001 = INSTANCE
            .addChannel(new QuantityChannel("10001", "Fan speed current", ChannelGroup.AIRSUPPLY, Units.PERCENT));
