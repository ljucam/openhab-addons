 ...
 */
package org.openhab.binding.myuplink.internal.callback;
 ...
 */
@NonNullByDefault
public abstract class AbstractUplinkCommandCallback extends BufferingResponseListener implements MyUplinkCommand {
     ...
     * the configuration
     */
    protected final MyUplinkConfiguration config;
     ...
     * @param config
     */
    public AbstractUplinkCommandCallback(MyUplinkConfiguration config) {
     ...
     * @param config
     */
    public AbstractUplinkCommandCallback(MyUplinkConfiguration config, StatusUpdateListener listener) {
        this(config);
