 ...
 */
@NonNullByDefault
public final class MyUplinkBindingConstants {
    ...
    public static final String DEVICE_NPCS40 = "npcs40";
    ...
    public static final ThingTypeUID THING_TYPE_NPCS40 = new ThingTypeUID(BINDING_ID, DEVICE_NPCS40);

    // List of all Channel ids ==> see UplinkDataChannels

    // URLs
    public static final String LOGIN_URL = "https://www.myupway.com/LogIn";
    // public static final String DATA_API_URL = "https://www.myupway.com/PrivateAPI/QueueValues";
    public static final String DATA_API_URL = "https://www.myupway.com/PrivateAPI/Values";
    public static final String MANAGE_API_BASE_URL = "https://www.myupway.com/System/";
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(THING_TYPE_VVM320, THING_TYPE_VVM310, THING_TYPE_F730, THING_TYPE_F750,
                    THING_TYPE_F1145, THING_TYPE_F1155, THING_TYPE_NPCS40).collect(Collectors.toSet()));
}
