...
import org.openhab.binding.myuplink.internal.command.Login;
...
/**
 * This class handles requests to the MyUplink web interface. It manages authentication and wraps commands.
 *
...
public class UplinkWebInterface implements AtomicReferenceTrait {
     ...
     * Configuration
     */
    private MyUplinkConfiguration config;

    /**
     * handler for updating thing status
     */
    private final MyUplinkHandler uplinkHandler;
     ...
     */
    public UplinkWebInterface(ScheduledExecutorService scheduler, MyUplinkHandler handler, HttpClient httpClient) {
    ...
    /**
     * authenticates with the MyUplink WEB interface
     *
