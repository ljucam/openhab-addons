...
public final class VVM320Channels extends BaseChannels {
    ...
    public static final Channel CH_44302 = INSTANCE
            .addChannel(new QuantityChannel("44302", "Heat Meter - Cooling Cpr EP14", ChannelGroup.GENERAL,
                    ScaleFactor.DIV_10, MetricPrefix.KILO(Units.WATT_HOUR)));
    ...
    public static final Channel CH_44396 = INSTANCE.addChannel(
            new QuantityChannel("44396", "EB101 Speed charge pump", ChannelGroup.COMPRESSOR, Units.PERCENT));
    ...
    public static final Channel CH_44073 = INSTANCE.addChannel(
            new QuantityChannel("44073", "EB101-EP14 Tot. HW op.time compr", ChannelGroup.COMPRESSOR, Units.HOUR));
    public static final Channel CH_40737 = INSTANCE.addChannel(
            new QuantityChannel("40737", "EB101-EP14 Tot. Cooling op.time compr", ChannelGroup.COMPRESSOR, Units.HOUR));
    public static final Channel CH_44071 = INSTANCE.addChannel(
            new QuantityChannel("44071", "EB101-EP14 Tot. op.time compr", ChannelGroup.COMPRESSOR, Units.HOUR));
    ...
    public static final Channel CH_40782 = INSTANCE.addChannel(
            new QuantityChannel("40782", "EB101 Cpr Frequency Desired F2040", ChannelGroup.COMPRESSOR, Units.HERTZ));
    public static final Channel CH_44701 = INSTANCE.addChannel(new QuantityChannel("44701",
    ...
    public static final Channel CH_44700 = INSTANCE.addChannel(new QuantityChannel("44700",
    ...
    public static final Channel CH_40311 = INSTANCE.addChannel(
            new QuantityChannel("40311", "External ERS accessory GQ2 speed", ChannelGroup.AIRSUPPLY, Units.PERCENT));
    public static final Channel CH_40312 = INSTANCE.addChannel(
            new QuantityChannel("40312", "External ERS accessory GQ3speed", ChannelGroup.AIRSUPPLY, Units.PERCENT));
